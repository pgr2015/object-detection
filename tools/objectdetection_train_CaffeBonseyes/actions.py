...
def perform_training_caffe(context: Context[ModelEditor], model: ModelEditor, training_set: BlobDataViewer,
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        proto_generator_BonseyesCaffe(deploy_path, 'deploy', tmp_dir, label_map, int(num_labels),
...
def create(context: Context[ModelEditor], model: ModelEditor, training_set: BlobDataViewer, label_map: str,
